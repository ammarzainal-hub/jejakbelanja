...
| `categories_cache_v2` | Senarai kategori dan ikon di browser `localStorage` | Tamat selepas 6 jam / Refresh Belanja / Refresh Semua |
...
- Cache kategori frontend disimpan dalam `localStorage` selama 6 jam dan dibuang apabila pengguna menekan Refresh Belanja atau Refresh Semua.
